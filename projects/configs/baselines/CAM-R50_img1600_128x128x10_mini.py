...
occ_path = "./data_mini/nuScenes-Occupancy-v1.0"
depth_gt_path = './data_mini/depth_gt'
train_ann_file = "./data_mini/nuscenes/nuscenes_infos_train.pkl"
val_ann_file = "./data_mini/nuscenes/nuscenes_infos_val.pkl"
